    ...
    *,
    ...
    intent_router = SpecialistDefinition(
        ...
        instruction=_with_handoff_protocol(
            ...
            "outputConcepts, platformRecommendations, assumptions, deliverableName, scheduledFor, dependencyItemIds, requiredAssetIds, appendParseReceipt, "
            ...
            "For append_deliverable, preserve every operator-supplied dependency item name/ID, source URL, and required asset ID in its dedicated field; if any dependency, source, attachment, asset, or trailing clause cannot be represented exactly, request appendConstraints clarification instead of emitting a complete append route. appendParseReceipt is host-issued proof and must be null in model output. "
