...
_PUBLIC_FIXTURES: dict[str, tuple[str, frozenset[str]]] = {
    ...
    "planner-no-authority": (
        ...
        frozenset({
            ...
            "public:authority:planner-proposes-only",
            "Delegate this request to flo_content_engine exactly once. Use the typed payload already present in managed session state.",
    ...
    "copywriter-references": (
        ...
        frozenset({
            ...
            "harmonia", "public-eval-user", "flo_content_engine", "synthetic demo",
            "Delegate this request to flo_content_engine exactly once for the public copywriter contract.",
            ...
            '{"actions":[{"type":"publish_x_post","text":"Reviewed synthetic draft"}]}',
            "noni_copywriter", "publish_x_post",
    ...
    "editor-preservation": (
        ...
        frozenset({
            ...
            "harmonia", "public-eval-user", "flo_content_engine", "synthetic demo",
            "Delegate this request to flo_content_engine exactly once for the public editor contract.",
            "harmonia_contract", "editor", "d1", "x", "m1", "proof", "bounded proof",
            ...
            '{"drafts":[{"id":"d1","platform":"x","momentId":"m1","text":"Original synthetic draft"}]}',
            '{"actions":[{"type":"publish_x_post","text":"Edited synthetic draft"}]}',
            "dara_editor", "publish_x_post",
            '{"kind":"editor"}', "noni_copywriter",
        }),
    ),
}
