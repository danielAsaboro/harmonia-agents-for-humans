...
<CardGroup cols={3}>
  ...
  <Card title="Flo" icon="people-arrows">Runs the bounded Noni ↔ Dara production loop for that selected item.</Card>
</CardGroup>
...
| Dara | structured accept/revise review in a deterministic two-pass maximum | exact Noni draft and immutable production input | rewrite copy, replace evidence, request a third pass, or create authority |
