...
drafting. Skill activation then exposes exactly two additional reads:
...
It has no trend-feed, Memory Bank, approval, or effect tool. The ten references cover thought leadership,
