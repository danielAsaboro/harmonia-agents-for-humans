...
Use [Agent skills, tools, prompts, and traces](/reference/agent-runtime-inventory) for the canonical
runtime inventory and [Agent contracts](/reference/agent-contracts) for exact handoff boundaries.
