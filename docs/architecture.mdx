...
| Noni copywriter | Gemini 3.5 Flash | 0.8 / 2,048 | skill trace, references, grounding, and X length | selected Temi item + exact Ryan brief + referenced Nimi evidence + local writing skill | research, access Memory Bank, inspect the rest of the plan, create facts, approve, publish |
