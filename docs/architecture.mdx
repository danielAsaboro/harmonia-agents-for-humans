...
flowchart TB
    ...
    subgraph WebApp["Web application (Next.js / Cloud Run)"]
        ...
        UPLOAD[Resumable upload broker<br/>metadata verification]
...
Data retention periods, legal holds, customer-managed encryption, workspace export/deletion, organization-policy integration, and formal regulatory certification remain deployment-specific work. They must not be implied by the controls above.
