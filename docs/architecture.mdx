...
| Nimi analyst | Gemini 3.5 Flash multimodal | 0.2 / 2,048 | quote/time/frame grounding | bounded source media + transcript | invent evidence, define strategy, approve, publish |
