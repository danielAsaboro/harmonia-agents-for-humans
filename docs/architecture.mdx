...
| Dara editor | Gemini 3.5 Flash | 0.2 / 2,048 | exact lineage, grounding, brief, brand, platform, CTA, and safety review | exact Noni draft + immutable production input; no tools | rewrite copy, create facts or authority, approve, publish |
