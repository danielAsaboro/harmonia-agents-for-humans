...
| `COPYWRITER_MODEL_ID` | no | `gemma-3-12b-it` | Noni's open-model endpoint label |
...
| `GEMMA_VERTEX_ENDPOINT` | real drafting | — | Full Vertex endpoint resource backing Noni; no fallback when absent |
