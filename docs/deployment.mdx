...
OIDC POST. Do not enable the legacy resident loops in Cloud Run; scheduled publishing, proactive
checks, and retention are driven by this durable external tick and protected by workspace leases.
