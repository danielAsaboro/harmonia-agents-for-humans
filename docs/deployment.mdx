...
Deploy a fresh cognitive-hierarchy revision for every rollout that changes ADK agents or schemas, then point the Cloud Run worker at the returned resource:
