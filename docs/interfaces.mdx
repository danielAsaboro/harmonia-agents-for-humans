...
- **Calendar** — content item lifecycle (draft → scheduled → awaiting final review → published), scheduling modes, media attachments, and explicit Google Calendar Add/Update/Remove controls when the scoped connection is active
