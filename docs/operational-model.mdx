...
| draft | agentic cognition in a bounded ADK loop | platform-native language | selected item only; Noni → Dara → bounded Noni revision; preserved references; no effect authority |
