...
- Nova receives a read-only ADK `SkillToolset`; Noni receives bounded writing-skill and grounded-research tools. Other core specialists are tool-free.
- Callbacks attach authorized media evidence and reset, record, and validate real Ryan, Noni, and Nova tool traces.
