...
- Nova receives a read-only ADK `SkillToolset`; Noni has a filesystem writing skill plus separate grounded-research tools; Dara receives only its filesystem editing-skill loaders. Other core specialists are tool-free.
