...
Harmonia's monitoring surface is assembled from durable DynamoDB records and bounded activity telemetry. It does not treat process memory or model narration as operational truth.
