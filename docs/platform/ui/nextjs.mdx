...
- Server libraries under `src/lib/` enforce tenancy, decisions, DynamoDB transitions, integration contracts, and AI SDK hydration.
...
Next.js does not run agent reasoning. It invokes the private worker and renders validated results persisted in DynamoDB.
