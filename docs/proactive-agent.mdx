...
- **Calendar gap scan**: grounded in *your* data — operator goals (voice, topics, weekly target) and your best-performing past posts. Under `HARMONIA_MOCK_AI=1` all ideation comes from deterministic fixtures.
