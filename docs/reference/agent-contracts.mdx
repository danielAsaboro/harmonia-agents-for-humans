...
The ADK root is `HarmoniaCoordinator`, a deterministic `BaseAgent`. Specialist selection comes from host-owned session state. Models cannot choose arbitrary recipients or establish workflow authority through prose.
