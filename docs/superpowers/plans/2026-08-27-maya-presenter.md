...
- [x] Add deterministic evaluation cases and update current architecture documentation.
- [x] Run the complete Python/application suites, lint, TypeScript, production build, and diff checks.
- [ ] Commit the isolated branch, fast-forward local main, and clean only Maya's branch/worktree.
