...
4. Align all five Nova skills and deterministic evaluation fixtures.
5. Update current architecture and interface documentation.
6. Run focused and complete Python/TypeScript tests, lint, type checking,
   production build, and final diff review before committing.
