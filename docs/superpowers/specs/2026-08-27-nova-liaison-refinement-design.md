...
Strands callbacks reset and record the actual tool sequence and envelopes for each
...
publishing, receipts, verification, credentials, budgets, and DynamoDB writes
