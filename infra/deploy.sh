...
MODEL_ID="${MODEL_ID:-gemini-3.7-flash}"
COORDINATOR_MODEL_ID="${COORDINATOR_MODEL_ID:-gemini-3.7-flash}"
STRATEGIST_MODEL_ID="${STRATEGIST_MODEL_ID:-gemini-3.7-flash}"
ANALYST_MODEL_ID="${ANALYST_MODEL_ID:-gemini-3.7-flash}"
COPYWRITER_MODEL_ID="${COPYWRITER_MODEL_ID:-gemini-3.7-flash}"
EDITOR_MODEL_ID="${EDITOR_MODEL_ID:-gemini-3.7-flash}"
PLANNER_MODEL_ID="${PLANNER_MODEL_ID:-gemini-3.7-flash}"
PRESENTER_MODEL_ID="${PRESENTER_MODEL_ID:-gemini-3.7-flash}"
MODEL_PRICING_VERSION="${MODEL_PRICING_VERSION:-2026-09-02}"
