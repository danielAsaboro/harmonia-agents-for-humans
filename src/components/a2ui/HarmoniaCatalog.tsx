...
const customImplementations: ReactComponentImplementation[] = [
  ...
  createComponentImplementation(DraftComparisonApi, ({ props, buildChild }) => { const { children, ...rest } = props; return <DraftComparison {...rest}>{builtChildren(children, buildChild)}</DraftComparison>; }),
