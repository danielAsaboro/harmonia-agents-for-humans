import type { EvidenceRef, Angle, ContentStrategy, EditorialPlan, EffectClaimSummary, Moment, PlannedAction, PostDraft, Receipt, Stage, StrategyApproval } from "@/lib/types";
