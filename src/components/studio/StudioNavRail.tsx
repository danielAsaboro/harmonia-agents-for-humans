...
export function StudioNavRail() {
  return (
    <nav className="hidden h-full flex-col items-center gap-1 bg-[#11110f] py-4 text-white lg:flex" aria-label="Primary">
      <Link href="/" aria-label="Harmonia home" className="mb-7 grid h-9 w-9 -rotate-3 place-items-center overflow-hidden rounded-xl bg-[#080b08] ring-1 ring-[#d8ff3e]/40"><BrandMark className="h-full w-full object-contain" decorative /></Link>
