...
const nodes: ArchitectureNode[] = [
  ...
  node({ id: "agent-noni", name: "Noni copywriter", kind: "agent", layer: "agents", parentId: "workflow-writing-review", summary: "Creates one grounded platform-native draft and at most one issue-bound revision from the selected item, exact Ryan brief, and referenced Nimi evidence.", statuses: ["offline-verified", "pending-live"], authorities: ["propose"], dataScope: "workspace-brand", stateLifetime: "ephemeral", model: { name: "Gemma 3 12B IT" }, promptResponsibility: "Produce strict claim-led copy with exact lineage, evidence, constraints, CTA, and platform bounds; no tools or effect authority." }),
  node({ id: "agent-dara", name: "Dara editor", kind: "agent", layer: "agents", parentId: "workflow-writing-review", summary: "Returns a structured accept/revise verdict for the exact Noni draft; deterministic code permits at most one revision and requires final acceptance.", statuses: ["offline-verified", "pending-live"], authorities: ["propose"], dataScope: "workspace-brand", stateLifetime: "ephemeral", model: { name: "Gemini 3.5 Flash" }, promptResponsibility: "Review grounding, brief alignment, brand voice, platform constraints, CTA, safety, and clarity without rewriting copy or creating facts." }),
