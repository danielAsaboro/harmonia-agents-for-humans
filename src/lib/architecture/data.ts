...
const nodes: ArchitectureNode[] = [
  ...
  node({ id: "surface-console", name: "Conversational Console + AI SDK", kind: "surface", layer: "surfaces", parentId: "group-surfaces", summary: "Natural-language job and status surface with a validated living canvas.", authorities: ["read", "write"], dataScope: "workspace", sourceFiles: ["src/components/ChatConsole.tsx"], docs: ["ai-sdk-console"] }),
  ...
  ...[
    ...
    ["ai-sdk", "AI SDK renderer", "Validated declarative components; no generated JavaScript or arbitrary callbacks."],
  ...
  node({ id: "api-chat", name: "Chat + AI SDK", kind: "route", layer: "apis", parentId: "group-apis", summary: "Chat, transport streaming, replay, attachments, and registered-operation decisions.", authorities: ["read", "write"], dataScope: "workspace", representativeRoutes: ["/api/chat", "/api/chat/stream", "/api/chat/runs/{id}/events", "/api/chat/attachments/*", "/api/chat/operations/{id}/decision"] }),
