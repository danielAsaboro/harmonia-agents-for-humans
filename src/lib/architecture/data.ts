...
const nodes: ArchitectureNode[] = [
  ...
  node({ id: "agent-noni", name: "Noni copywriter", kind: "agent", layer: "agents", parentId: "workflow-writing-review", summary: "Creates one grounded platform-native draft and at most one issue-bound revision from the selected item, exact Ryan brief, and referenced Nimi evidence.", statuses: ["offline-verified", "pending-live"], authorities: ["propose"], dataScope: "workspace-brand", stateLifetime: "ephemeral", model: { name: "Gemini 3.5 Flash" }, promptResponsibility: "Load noni-writing-skills and relevant writing references, then produce strict claim-led copy with exact evidence lineage, constraints, CTA, and platform bounds; no research or effect authority.", skills: ["noni-writing-skills"] }),
  node({ id: "agent-dara", name: "Dara editor", kind: "agent", layer: "agents", parentId: "workflow-writing-review", summary: "Returns all seven editorial checks plus a bounded accept/revise assessment; deterministic code assigns review metadata, permits at most one revision, and requires complete issue resolution.", statuses: ["offline-verified", "pending-live"], authorities: ["propose"], dataScope: "workspace-brand", stateLifetime: "ephemeral", model: { name: "Gemini 3.5 Flash" }, promptResponsibility: "Assess grounding, brief alignment, brand voice, platform constraints, CTA, safety, and clarity with supplied provenance; no workflow metadata, replacement copy, facts, or effects." }),
  ...
  group("group-skills", "Runtime skills + bounded tools", "skills", "Noni's writing guidance and Nova's read-only intelligence skills."),
