...
const nodes: ArchitectureNode[] = [
  ...
  node({ id: "tool-google-search-grounding", name: "google_search", kind: "tool", layer: "skills", parentId: "group-skills", summary: "Native ADK Google Search grounding isolated behind Noni's brief-bound research agent; chunks and supports are validated before claims are accepted.", statuses: ["offline-verified", "read-only", "pending-live"], authorities: ["read"], dataScope: "public", stateLifetime: "stateless", sourceFiles: ["agent/harmonia_agent/noni_skills.py", "agent/harmonia_agent/team_runtime.py"] }),
