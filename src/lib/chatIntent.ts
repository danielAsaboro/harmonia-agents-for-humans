...
export function normalizeParsedIntent(value: unknown): ParsedIntent {
  ...
  return {
    ...
    ...(raw.appendParseReceipt && typeof raw.appendParseReceipt === "object" ? { appendParseReceipt: raw.appendParseReceipt as ParsedIntent["appendParseReceipt"] } : {}),
  };
}
