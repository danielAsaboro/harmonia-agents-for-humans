...
}).strict().superRefine((value, context) => { if (value.outputType !== value.payload.kind) context.addIssue({ code: "custom", path: ["payload", "kind"], message: "payload kind must match output type" }); });
